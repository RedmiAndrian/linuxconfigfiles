...
/* appearance */
static const unsigned int gappx = 8;      /* gaps (with dwm patch) */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_white, "-sb", col_orange, "-sf", col_black, NULL };
